...
\setlength{\parindent}{.25in}
    ...
    % Document parameters
    % Document title
    \title{Engineering Practice Tutorial \#1 (10.21.2022)}
...
\subsection*{2. Reproducible Research}

\hspace*{.25in}% 
In user's point of view, they want to utilize or reproduce the results
on the paper. Therefore, need to manage packages, code, and data. 
\begin{itemize}
\tightlist
\item
  \textbf{Managing pacakge dependecies}
  \begin{itemize}
  \tightlist
  \item
    pip package
...
\subsection*{3. GPU management}
\hspace*{.25in}% 
\texttt{SLURM} is used for GPU clustering and allocation
\begin{itemize}
\tightlist
\item
    \href{https://slurm.schedmd.com/overview.html}{\texttt{SLURM}} - open source, fault-tolerant, and highly scalable
...
\item
  ...
  \tightlist
  \item
    \texttt{/data}, \texttt{/home} directories are NFS
  \item
    Locations
    ...
    \item
      ...
      \item
        user accounts are located under /home directory. Therefore, it
        would be a good practice to save extremely large models and data under \texttt{/data}
      \end{itemize}
    \end{itemize}
  \end{itemize}
\item
...
\subsection*{5. Experiments management}
...
\item
  ...
  \item
    ...
    \tightlist
    \item
      contains all necessary files related to the experiment :
      tokenizers, parameters, models, and etc.
    \end{itemize}
  \item
    ...
    \item
      e.g.)
      \texttt{\{Path\}/experiment/\{github\ code\ tag\ or\ hash\ ID\}/\{slurm\_id\}/trial\_1}
    \end{itemize}
  \end{itemize}
\item
  ...
  \tightlist
  \item
    Use git tag feature (or hash ID) as identifier for training
    experiment
    ...
    \item
      e.g.)
      \texttt{\{Path\}/experiment/\{github\ code\ tag\ or\ hash\ ID\}/\{slurm\_id\}/trial\_2}
    \end{itemize}
  \item
    ...
    \tightlist
    \item
      Hard to track down corressponding code to each experiment when
      there are some direct modifications on the server.
    \end{itemize}
  \item
